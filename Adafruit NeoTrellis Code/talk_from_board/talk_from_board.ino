...
As is this example shows use of two Trellis boards
...
Adafruit_Trellis t_array[4][4] = {
  
  { Adafruit_Trellis(0x2F),
  Adafruit_Trellis(0x2E),
  Adafruit_Trellis(0x32),
  Adafruit_Trellis(0x30) 
  }
...
/*
If you were using a 2x2 array of Trellis boards, the above lines would be:

#define Y_DIM 8 //number of rows of key
#define X_DIM 8 //number of columns of keys

//create a matrix of trellis panels
Adafruit_Trellis t_array[Y_DIM/4][X_DIM/4] = {
  
  { Adafruit_Trellis(0x2E), Adafruit_Trellis(0x2F) },

  { Adafruit_Trellis(LOWER_LEFT_I2C_ADDR), Adafruit_Trellis(LOWER_RIGHT_I2C_ADDR) }
  
};
*/

//pass this matrix to the multitrellis object
Adafruit_MultiTrellis trellis((Adafruit_Trellis *)t_array, Y_DIM/4, X_DIM/4);
